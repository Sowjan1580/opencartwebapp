package com.amazon.removefromecart.test;
...
public class RemoveFormCartTest extends BaseTest {
	...
	@Test(priority = 5)
	public void removefromecart() throws InterruptedException {

		rfcpage.clickOnCartButton();
		rfcpage.increaseQuantity();
		rfcpage.deleteApple();
		rfcpage.deleteSamsung();
	}
